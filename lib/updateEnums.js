...
module.exports = async ({ editor, context }) => {
  ...
  if (languageId !== 'typescript') {
    msg.error(`Please use in .ts file`)
    return
  }
  ...
  try {
    ...
    console.log('temp', ...vscode.workspace.getConfiguration().get('extension.headers'))
    ...
    console.log('error', e)
    msg.error(`Data Structure has problem`)
  }
}
